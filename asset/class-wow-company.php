	...
	final class Wow_Company{
		...
		public function admin_footer_text( $footer_text ) {
			...
			if ( $wow_company_plugin == true ) {
				$rate_text = sprintf( '<span id="footer-thankyou">Developed by <a href="https://codecanyon.net/user/wow-company" target="_blank">Wow-Company</a> | <a href="https://www.facebook.com/wowaffect/" target="_blank">Join us on Facebook</a></span>');
